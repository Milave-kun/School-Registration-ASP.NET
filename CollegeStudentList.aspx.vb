Public Class CollegeStudentList
    ...
    Private Sub BindGrid()
        gvStudents.DataSource = students.GetStudents("College", txtSearch.Text, ddlFilter.SelectedValue)
        gvStudents.DataBind()
    End Sub
    ...
    Protected Sub gvStudents_RowUpdating(sender As Object, e As GridViewUpdateEventArgs)
        ...
        students.UpdateStudent(student_id, firstName, lastName, gender, "College", section) ' Passing student_id
